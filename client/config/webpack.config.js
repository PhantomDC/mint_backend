	...
	return {
		...
		output: {
			...
			filename: isEnvProduction
				? 'client/static/js/[name].[contenthash:8].js'
				: isEnvDevelopment && 'static/js/bundle.js',
			// There are also additional JS chunk files if you use code splitting.
			chunkFilename: isEnvProduction
				? 'client/static/js/[name].[contenthash:8].chunk.js'
				: isEnvDevelopment && 'static/js/[name].chunk.js',
			assetModuleFilename: 'client/static/media/[name].[hash][ext]',
		...
		plugins: [
			...
			isEnvProduction &&
				new MiniCssExtractPlugin({
					...
					filename: 'client/static/css/[name].[contenthash:8].css',
					chunkFilename: 'client/static/css/[name].[contenthash:8].chunk.css',
				}),
